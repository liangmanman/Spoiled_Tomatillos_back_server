...
export const REVIEWS_OF_MOVIE_API = API + '/reviews/movie?movieId=';
export const REVIEWS_OF_USER_API = API + '/reviews/user?userId=';
...
export const FRIENDS_OF_USER_API = API + '/friends/friends';
