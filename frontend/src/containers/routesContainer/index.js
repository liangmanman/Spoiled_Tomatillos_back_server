...
import {SIGN_IN_URI, SIGN_UP_URI, SEARCH_RESULT_URI, MOVIE_URI, USER_URI, GROUP_URI} from "./uriConstants";
  ...
  renderRouter() {
    ...
    return (
      <Switch>
        ...
        <Route key={GROUP_URI} path={GROUP_URI} component={GroupRoute}/>
